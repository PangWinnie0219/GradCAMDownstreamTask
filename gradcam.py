...
# from gradcam_library import GradCAM, show_cam_on_image  # to study for the code only 
...
parser.add_argument('--cls',    default=7,          type=int)
...
parser.add_argument('--tclass',   default=0,    type=int,   help='target class to show the output of Grad-CAM')
    ...
    if model_used == 'ResNet50':
        ...
        for idx, data in enumerate(val_loader):
            ...
            if idx >= args.bidx:
                ...
                # print(np.min(cam_gb), np.max(cam_gb))

                # cv2.imwrite(f'GradCAM_cam.jpg', visualization)
                # cv2.imwrite(f'GradCAM_gb.jpg', gb)
...
def main():
    ...
    val_dataset_40, val_num_each_40 = get_data('./train_val_paths_labels.pkl')  
